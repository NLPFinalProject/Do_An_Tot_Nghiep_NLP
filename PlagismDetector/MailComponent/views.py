...
def sendVerificationMail(email):
    ...
    email = EmailMessage(
        'Hello',
        'this is a confirmnation mail,'
        ' please enter the code below ' + str(number),
...
def sendExportMail(data):
    ...
    mail.send_mail('Hello', plain_message, 'kaitouthuan@gmail.com',
                   [user], html_message=html_message)
